...
def generate_user(id):
    ...
    tmp = db_model.User(id, generate_email_from_name(name, last_name), name, last_name, random.randint(1, CITIES_AMOUNT), random.randint(1, COUNTRIES_AMOUNT), random.randint(100000000, 999999999), fk.street_name(), fk.building_number(), fk.date_of_birth(minimum_age=16, maximum_age=80))
